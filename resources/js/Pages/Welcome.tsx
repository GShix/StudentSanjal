                ...
                <div className="header w-full">
                    <nav className="navbar bg-black text-white flex justify-center items-center w-full gap-5 max-sm:text-3xl mx-auto px-5">
                        ...
                        <div className="small-nav-link  w-full flex flex-col gap-4 absolute top-20 z-50 text-base bg-[#1a1a1a]  sm:hidden pl-5 py-2">
                            <ul>
                                ...
                                <li key={index} className="mb-3">
                                    <Link className="nav-link-item hover:text-[#c7ae6a] flex items-center" href={link.href}>
                                        <i className={`${link.icon} mr-2`}></i>
                                        <span className="block font-sans leading-none font-normal">{link.title}</span>
                                    </Link>
                                </li>
                                ))}
                            </ul>
                        ...
                        <div className="large-nav-link max-sm:hidden w-full flex justify-around font-normal border-r border-r-1 pr-1">
                            ...
                            {navLinks.map((link,index)=>(
                                <li key={index}>
                                    <Link className="nav-link-item hover:text-[#c7ae6a] flex flex-col items-center" href={link.href}>
                                        <i className={link.icon}></i>
                                        <span className="block font-sans leading-none font-normal text-sm">{link.title}</span>
                                    </Link>
                                </li>
                            ))}
                            </ul>
                ...
                <footer className="bg-[#000000]">
                    <div className="mx-auto max-w-5xl px-5 py-5 sm:px-6 lg:px-8">
                        ...
                        <ul className="mt-8 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                            <li><a className="text-gray-300 transition hover:text-[#c7ae6a]/75" href="#"> About </a></li>

                            <li><a className="text-gray-300 transition hover:text-[#c7ae6a]" href="#"> Careers </a></li>
                            ...
                            <li><a className="text-gray-300 transition hover:text-[#c7ae6a]" href="#"> Blog </a></li>
                        </ul>

                        <p className="text-gray-300 w-full text-center mt-9 text-sm">&copy; 2024 StudentSanjal | All Rights Reserved</p>

                        <ul className="mt-10 mb-4 flex justify-center gap-6 md:gap-8">
                            <li>
                                <a href="#" rel="noreferrer" target="_blank" className="text-gray-700 transition hover:text-gray-700/75">
                                    <span className="sr-only">Facebook</span>
                                    <svg className="size-6" fill="#e3d6b4" viewBox="0 0 24 24" aria-hidden="true">
                                        <path
                                            fillRule="evenodd"
