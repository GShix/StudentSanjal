...
const StartChat = () => {
    ...
    console.log(chatGarneSathi,chats)
            ...
            <div className="chat-ui min-h-[85vh] pb-3 -mt-1 grid grid-cols-2 gap-4">
                ...
                <div className="second-col bg-gray-100 rounded-lg h-full">
                    ...
                    <div className="opern-chatter relative h-full z-10">
                        ...
                        <div className="message-items py-2">
                            {chats.map((chat: any) => (
                                    ...
                                    <div className="message-info">
                                        {chat.sender_id === user.id ? (
                                            ...
                                            <div className="sender-walako-message flex justify-end w-full mb-1">
                                                ...
                                                <span className="mr-2 text-gray-500 text-sm mt-[5px]">{formatTime(chat.created_at)}</span>
                                                <div>
                                                    {chat.text_field && <p className="bg-[#b99a45] text-gray-200 px-2 py-[2px] rounded-full">{chat.text_field}</p>}
                                                    {chat.media && <img src={chat.media} alt="Media" className="media-image w-16 h-16 mt-[3px] rounded-md" />}
                                                </div>
                                            </div>
                                        ) : (
                                            // <>
                                            ...
                                            <div className="receiver-walako-message flex justify-start w-full mb-1">
                                                ...
                                                <div>
                                                    {chat.text_field && <p className="bg-[#b99a45] text-gray-200 px-2 py-[2px] rounded-full">{chat.text_field}</p>}
                                                    {chat.media && <img src={chat.media} alt="Media" className="media-image w-16 h-16 mt-[3px]"/>}
                                                </div>
