...
const ChatUi = () => {
    ...
    return (
        <CleanHomeLayout>
            <Head title="Chat" />
            <div className="chat-ui min-h-screen p-2 grid grid-cols-2 gap-4">
                {/* Left Column */}
                    ...
                    <div className="chat-box py-2">
                        ...
                        <div className="connection-stories px-2 py-2 flex gap-6 items-center h-40">
                            <div className="your flex items-center flex-col max-w-24">
                                <div className="relative bg-white text-gray-500 rounded-lg shadow-lg px-4 py-[6px] inline-block mb-1 cursor-pointer" onClick={() => setShowNoteCreate(true)}>
                            ...
                            {otherUsers.map((other: any) => (
                                <div key={other.id} className="others flex items-center flex-col">
                                    {other.note && (
                                    <div className="relative bg-white text-gray-500 rounded-lg shadow-lg px-4 py-[6px] mb-1 block">
                                        {other.note && other.note.length > 0 ? other.note[0].title : ""}
                                        <div className="absolute b500 top-7 rotate-90 w-0 h-0 border-t-[15px] border-t-white border-r-[15px] border-r-transparent z-99"></div>
                                    </div>
                                    )}
                                    <div className={`posts-users-icon w-20 h-20 p-[1px] bg-white rounded-full relative flex justify-end max-w-20 ${other.note ? 'mt-0' : 'mt-10'}`}>
                    ...
                    {showNoteCreate && (
                        <div className="share-new-note px-4">
                            ...
                            <div className="flex flex-col justify-center items-center h-96">
                                <div className="relative bg-white text-gray-500 rounded-lg shadow-lg px-4 py-[6px] inline-block mb-1">
