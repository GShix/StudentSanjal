...
//                 // </div> */}
//                 <div className="what-in-your-min bg-gray-100 rounded-xl flex justify-between gap-2.5 px-2.5 py-4 border border-gray-400/50">
...
//                                 <span className="recommendation-person-name text-base font-semibold block">Boy1 Don</span>
//                                 <span className="recommendation-person-headline block text-sm text-gray-700/80">Laravel Developer | React JS</span>
//                                 <p className="text-xs text-gray-700/80">4 mutual connections</p>
//                             </div>
//                         </div>
